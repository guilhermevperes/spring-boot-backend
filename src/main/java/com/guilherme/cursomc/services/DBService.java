...
public class DBService {
        ...
        public void instantiateTestDataBase() throws Exception {
                ...
                Client cli2 = new Client(null, "Ana Costa", "guilherme.vperes@gmail.com", "72842940865",
                                ClientType.PESSOAFISICA, pe.encode("123456"));
                ...
                Address address2 = new Address(null, "Avenida Matos", "105", "Sala 800", "Centro", "38770212", cli1,
                                c2);
                ...
                Payment payment2 = new PaymentTicket(null, PaymentState.PENDING, orderEntity2,
