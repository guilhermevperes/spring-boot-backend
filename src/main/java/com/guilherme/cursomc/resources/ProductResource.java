...
import com.guilherme.cursomc.DTO.ProductDTO;
import com.guilherme.cursomc.domain.Product;
import com.guilherme.cursomc.resources.utils.URL;
import com.guilherme.cursomc.services.ProductService;
...
public class ProductResource {
    ...
    public ResponseEntity<Page<ProductDTO>> findPage(@RequestParam(value = "name", defaultValue = "") String name,
        ...
        Page<Product> list = service.search(URL.decodeParam(name), URL.decodeIntList(categories), page, linesPerPage,
                orderBy, direction);
